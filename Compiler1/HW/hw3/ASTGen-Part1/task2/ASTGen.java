...
// -- Define the grammatical rules of the input language: -----
  ...
  static final public void AbstractCls() throws ParseException {
    jj_consume_token(2);
    jj_consume_token(1);
    Id();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public void BracketDecl() throws ParseException {
    ParenthDecl();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 6:
      CurlyBracket();
  ...
  static final public void AbstrArg() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 3:
      ParenthDecl();
      break;
  ...
  static final public void ParenthDecl() throws ParseException {
    jj_consume_token(3);
    Argument();
    label_2:
    while (true) {
  ...
  static final public void CurlyBracket() throws ParseException {
    jj_consume_token(6);
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6,0x6,0x8,0x48,0x40,0x8,0x10,0x6,0x6,0x3800,0x100,0x200,0x3800,};
   }
