...
//ClassDecl  -> "ClassDecl" <Id> [<Id>] {VarDecl} {MethodDecl}
  ...
  Ast.MethodDecl m;
    ...
    {if (true) return new Ast.ClassDecl(cn, pn, vl, ml);}
    throw new Error("Missing return statement in function");
  }
...
//MethodDecl -> "MethodDecl" Type <Id> "(" {Param} ")" {VarDecl} {Stmt}
  ...
  Ast.Stmt s;
    ...
    {if (true) return new Ast.MethodDecl(t, mn, fl, vl, sl);}
    throw new Error("Missing return statement in function");
  }
...
//VarDecl    -> "VarDecl" Type <Id> Exp
  ...
  Ast.Exp init;
    ...
    vn = Id();
    init = Exp();
    {if (true) return new Ast.VarDecl(t, vn, init);}
    throw new Error("Missing return statement in function");
  }
...
//Param      -> "(" Type <Id> ")"
 ...
 String vn; Ast.Type t;
    ...
    vn = Id();
    jj_consume_token(58);
    {if (true) return new Ast.Param(t, vn);}
    throw new Error("Missing return statement in function");
  }
    ...
    case 57:
      ...
      case kwUnop:
        ...
        case kwNewArray:
          ...
          et = Type();
          sz = IntLit();
                                              e = new Ast.NewArray(et, sz);
          break;
        case kwField:
          jj_consume_token(kwField);
          obj = Exp();
          vn = Id();
                                              e = new Ast.Field(obj, vn);
          break;
        case kwArrayElm:
...
//UOP    -> "-" | "!"
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4000,0x0,0x80000000,0x200000,0x0,0x80000000,0xc042200,0x1000100,0x80800,0xc042200,0x20000000,0xc042200,0x20000000,0x20000000,0x40c21480,0x40c21480,0x20000000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x80,0x0,0x0,0x2000000,0x0,0x20000002,0x0,0x2000001,0x20000002,0x20000e4,0x20000002,0x20000e4,0x20000e4,0x0,0x0,0x20000e4,0x1fbf00,0x4200,};
   }
